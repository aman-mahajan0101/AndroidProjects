...
import com.example.googlelensclone.BaseLensActivity.Companion.CAMERA_PERM_CODE
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(
            Runnable {
                ...
                imageAnalysis = ImageAnalysis.Builder()   //We could have set the backpressure andi inqueuedeoth functions here but we need the default one so not doing
                    .build()
